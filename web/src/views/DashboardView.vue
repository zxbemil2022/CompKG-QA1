...
const UserStatsComponent = defineAsyncComponent(() => import('@/components/dashboard/UserStatsComponent.vue'))
const ToolStatsComponent = defineAsyncComponent(() => import('@/components/dashboard/ToolStatsComponent.vue'))
const KnowledgeStatsComponent = defineAsyncComponent(() => import('@/components/dashboard/KnowledgeStatsComponent.vue'))
const AgentStatsComponent = defineAsyncComponent(() => import('@/components/dashboard/AgentStatsComponent.vue'))
const CallStatsComponent = defineAsyncComponent(() => import('@/components/dashboard/CallStatsComponent.vue'))
const StatsOverviewComponent = defineAsyncComponent(() => import('@/components/dashboard/StatsOverviewComponent.vue'))
const FeedbackModalComponent = defineAsyncComponent(() => import('@/components/dashboard/FeedbackModalComponent.vue'))
