...
export const databaseApi = {
   ...
   * @returns {Promise}
   */
  getOntologyDomains: async () => {
    return apiAdminGet('/api/knowledge/ontology/domains')
  },
   ...
   * @returns {Promise}
   */
  getDatabaseOntology: async (dbId) => {
    return apiAdminGet(`/api/knowledge/databases/${dbId}/ontology`)
  },
   ...
   * @returns {Promise}
   */
  updateDatabaseOntology: async (dbId, payload) => {
    return apiAdminPut(`/api/knowledge/databases/${dbId}/ontology`, payload)
  }
}
...
export const documentApi = {
   ...
   */
  rebuildDocumentGraph: async (dbId, docId, params = {}) => {
    return apiAdminPost(`/api/knowledge/databases/${dbId}/documents/${docId}/rebuild-graph`, params)
  },
