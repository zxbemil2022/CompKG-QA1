...
export const governanceApi = {
  auditCs408: async (datasetPath = 'examples/cs408/cs408_expert_seed.jsonl') =>
    apiAdminPost('/api/knowledge/cs408/audit', { dataset_path: datasetPath }),
  upgradeCs408: async (datasetPath = 'examples/cs408/cs408_expert_seed.jsonl', outputPath = null) =>
    apiAdminPost('/api/knowledge/cs408/upgrade', { dataset_path: datasetPath, output_path: outputPath }),
}
...
export const observabilityApi = {
  getMetrics: async () => apiAdminGet('/api/system/observability/metrics'),
  getFailures: async (limit = 50) => apiAdminGet(`/api/system/observability/failures?limit=${limit}`),
  getConfigFingerprint: async () => apiAdminGet('/api/system/config/fingerprint'),
}
